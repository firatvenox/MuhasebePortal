...
{
    public class CSLPlasmot
    {
        public List<CSL> Handle(DateTime fatdate, DateTime fatdate1)
        {
            List<CSL> tutarlar = new();
            ...
            return tutarlar.OrderByDescending(a => a.part).ToList();
        }
